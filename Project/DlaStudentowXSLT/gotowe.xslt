        ...
        <html>
            ...
            <body>
                ...
                <footer>
                    ...
                    <!--  wywołanie szablonu pozwalającego na wyświetlenie informacji o imieniu oraz
                    nazwisku studenta  -->
                </footer>
            </body>
        </html>
    </xsl:template>
    <xsl:template match="author"> Copyright 2022, <xsl:value-of select="surname" />
<xsl:value-of
            select="name" />
    </xsl:template>
    ...
    <xsl:template match="person">
        ...
        <p> Date of birth: <xsl:value-of select="birth" />
        </p>
        <xsl:if test="@alive='no'">
            <p> Date of death: <xsl:value-of select="death" />
            </p>
        </xsl:if>
